/*
  ...
  1. Tables Created:
    ...
    - user_exercises: Links users to their exercises with progress tracking
    - workout_history: Stores workout sessions
  ...
  2. Security:
    ...
    - Authenticated users can:
      ...
      - Manage their exercise progress
...
-- Enable RLS on user exercises
ALTER TABLE user_exercises ENABLE ROW LEVEL SECURITY;

-- Create user exercises policies
...
-- Enable RLS on workout history
ALTER TABLE workout_history ENABLE ROW LEVEL SECURITY;

-- Create workout history policies
